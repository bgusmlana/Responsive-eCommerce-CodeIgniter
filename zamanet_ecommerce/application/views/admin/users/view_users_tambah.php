      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?= base_url('admin/tambah_manajemenuser') ?>" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type='radio' name='g' value='user'> Seller &nbsp; <input type='radio' name='g' value='admin'> Administrator
                  </div>
                </div>

                <button type='submit' name='submit' class='btn btn-primary btn-sm'>Simpan</button>
                <a href='<?= base_url('admin/manajemenuser') ?>'><button type='button' class='btn btn-secondary btn-sm float-right'>Batal</button></a>
