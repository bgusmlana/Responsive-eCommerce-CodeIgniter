  ...
  <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item has-treeview">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/kategoriartikel') ?>" class="nav-link">
            <i class="far fa-circle nav-icon text-sm"></i>
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/tagartikel') ?>" class="nav-link">
            <i class="far fa-circle nav-icon text-sm"></i>
            <p>Tag Artikel</p>
          </a>
        </li>
    ...
    <?php if ($this->session->level == 1) { ?>
      ...
      <li class="nav-item has-treeview">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/identitaswebsite') ?>" class="nav-link">
              <i class="far fa-circle nav-icon text-sm"></i>
              <p>Identitas</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/menuwebsite') ?>" class="nav-link">
              <i class="far fa-circle nav-icon text-sm"></i>
              <p>Menu</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/halamanbaru') ?>" class="nav-link">
              <i class="far fa-circle nav-icon text-sm"></i>
              <p>Halaman</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/logowebsite') ?>" class="nav-link">
              <i class="far fa-circle nav-icon text-sm"></i>
              <p>Logo</p>
            </a>
          </li>
    ...
    <li class="nav-item mt-2">
      <a href="<?= base_url('admin/edit_manajemenuser/') . $this->session->username ?>" class="nav-link">
