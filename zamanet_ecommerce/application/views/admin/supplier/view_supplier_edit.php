      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?= base_url('admin/editb_toko_supplier'); ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type='number' class='form-control' name='d' value='<?= $rows['no_hp']; ?>' required>
                  </div>
                </div>
                ...
                <a href='<?= base_url('admin/supplier'); ?>'><button type='button' class='btn btn-secondary btn-sm float-right'>Batal</button></a>
