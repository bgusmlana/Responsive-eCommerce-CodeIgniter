...
class Model_app extends CI_model
{
    ...
    function jual($id)
    {
        return $this->db->query("SELECT sum(a.jumlah) as jual FROM tb_toko_penjualandetail a JOIN tb_toko_penjualan b ON a.id_penjualan=b.id_penjualan where a.id_produk='$id' AND b.proses='1'");
    }

    function beli($id)
    {
        return $this->db->query("SELECT sum(a.jumlah_pesan) as beli FROM tb_toko_pembeliandetail a where a.id_produk='$id'");
    }

    function jual_umum($produk)
    {
        return $this->db->query("SELECT sum(jumlah) as jual FROM `tb_toko_penjualan` a JOIN tb_toko_penjualandetail b ON a.id_penjualan=b.id_penjualan where b.id_produk='$produk' AND a.proses!='0'");
    }

    function beli_umum($produk)
    {
        return $this->db->query("SELECT sum(jumlah_pesan) as beli FROM `tb_toko_pembeliandetail` where id_produk='$produk'");
    }
    ...
    {
        $this->db->join('tb_alamat', 'tb_alamat.id_pengguna = tb_pengguna.id_pengguna');
    ...
    function alamat_konsumen($id)
    {
        ...
        return $this->db->get_where('tb_alamat', "id_pengguna='$id'");
    }
